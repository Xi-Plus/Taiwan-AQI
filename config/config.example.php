...
$M["/help"] = "可用命令\n".
	"/add 顯示所有區域\n".
	"/add [區域] 顯示此區域測站\n".
	"/add [測站] 啟用此測站通知，當AQI超過{$C["AQIover"]}及變化超過{$C["AQIdiff"]}會通知\n".
	"/add [測站] [門檻值] 啟用此測站通知，當AQI超過\"門檻值\"及變化超過{$C["AQIdiff"]}會通知\n".
	"/add [測站] [門檻值] [變化值] 啟用此測站通知，當AQI超過\"門檻值\"及變化超過\"變化值\"會通知\n".
	"/del [測站] 停用此測站通知\n".
	"/list 列出已接收通知的測站\n".
	"/show 列出已接收通知測站的資料\n".
	"/help 顯示所有命令";
